...
# que sao armazenados para escrita posterior
# retorna variaveis preenchidas com os dados forcendidos
    ...
    while linha:
        ...
        if valor:              #se nao for vazio
            ...
            if (valor[0] == 'nos'):
                ...
                #print(nos)
                #guardo texto inutil para marcar lugar
            ...
            #procuro o valor 'nosf' na primeira string da lista
                ...
                #print(nosf)
                #guardo texto para retornar valor
                texto.append(valor[0])
            ...
            #procuro a lista de listas 'distancia'
                ...
                #guardo na memoria para chamar na saida
                texto.append(valor[0])
                ...
                texto.append(valor[0])
                #adiciono texto dentro da variavel vlc
                texto.append(' '.join(valor[3:]))
                #print(' '.join(valor[3:]))
                while valor[len(valor)-1] != '];':
                    linha = fhand.readline()
                    valor = linha.split()
            ...
            #Se nao eh uma secao de dados
                ...
                #print(valor)
                #armazeno texto inutil para recuperar mais tarde
                texto.append(valor)
